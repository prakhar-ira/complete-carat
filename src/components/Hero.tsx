          ...
          <div className="w-full px-4 sm:px-6 md:px-10 flex flex-col gap-4 sm:gap-6 pb-6 sm:pb-10">
            ...
            >
              ...
              <div className="flex flex-col gap-2 sm:gap-3">
                <h2 className="text-lg sm:text-xl md:text-2xl font-medium">Our Philosophy: Crafting Symbols of Love</h2>
                <p className="text-sm sm:text-base md:text-lg font-regular">
                  Welcome to Complete Carat, where our fervent commitment to excellence shapes every diamond ring we create. 
                  These aren't mere pieces of jewelry; they are emblems of love and commitment, crafted with unparalleled 
                  precision and quality. At Complete Carat, we stand apart in the world of fine jewelry, with each ring 
                  reflecting our ethos: excellence without compromise.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col gap-2 sm:gap-3">
                <h2 className="text-lg sm:text-xl md:text-2xl font-medium">Why Complete Carat Stands Out</h2>
                <p className="text-sm sm:text-base md:text-lg whitespace-pre-line font-regular">
                  Our expansive facility is a symphony of advanced technology and masterful artisans. We oversee every aspect of ring creation, from initial design to final polish, ensuring your dream ring materializes with extraordinary craftsmanship.
                  
                  Founder Involvement: The soul of Complete Carat lies in our founders' unwavering dedication. Their hands-on approach in every phase, from casting to setting, infuses each ring with a level of quality and personal touch rarely seen in the industry.
                  
                  In-House Production Excellence: We take immense pride in our policy of no outsourcing. Every element of your ring is meticulously crafted within our premises, guaranteeing consistency and flawlessness. This approach not only enhances quality but ensures each piece truly embodies the spirit of Complete Carat.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col gap-2 sm:gap-3">
                <h2 className="text-lg sm:text-xl md:text-2xl font-medium">Our Exquisite Selection</h2>
                <p className="text-sm sm:text-base md:text-lg font-regular">
                  Diamonds for every preference, diverse diamond shapes and style that speaks volumes. At Complete Carat, 
                  each ring is not just a product but a masterpiece, a testament to our passion and precision. We're devoted 
                  to crafting exceptional jewelry that celebrates your unique love story. Trust us to deliver not just a ring, 
                  but a timeless symbol of your bond.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="overflow-y-auto max-h-[80vh] py-12">
            ...
            >
              ...
              <p className="text-base sm:text-md md:text-md whitespace-pre-line">
                At Complete Carat, we believe that your satisfaction goes beyond the purchase. We're dedicated to making sure you feel confident and happy with your jewellery every step of the way. If for any reason you're not completely satisfied, we offer a 10-Day Money-Back Guarantee. You can return or exchange any items within 10 days of delivery, with no hassle and at no cost to you. 

                If you have any questions or concerns, we're here to assist you! To ensure that your return is processed smoothly, please ensure the item is in new, unworn condition and includes all original packaging, certificates, and documentation. A receipt or proof of purchase will also be required.
              </p>
            </motion.div>
            ...
            <div className="px-6 mb-8">
              <motion.div
                ...
                transition={{ delay: 0.3, duration: 0.4 }}
              >
                <h2 className="text-xl sm:text-2xl font-bold text-center mb-6">How to return items</h2>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-lg sm:text-xl font-bold">Start Your Return</h3>
                  <p className="text-base sm:text-lg">
                    Contact us at info@completecarat.com with your order number, and we'll guide you through the return process
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-lg sm:text-xl font-bold">Prepare the Item for Return</h3>
                  <p className="text-base sm:text-lg">
                    Once your return is initiated, we'll send you a pre-paid, insured shipping label along with simple instructions for how to return the item. Please package the jewelry securely in its original box, including all grading reports, appraisals, and accessories. For your security, please avoid writing "Complete Carat" on the exterior of the return box.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-lg sm:text-xl font-bold">Ship the Item Back</h3>
                  <p className="text-base sm:text-lg">
                    Use the provided return shipping label to send the item back to us. We highly recommend shipping with insurance for your peace of mind, as we are not responsible for any lost or stolen items that are returned without the provided label.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-lg sm:text-xl font-bold">After We Receive Your Return</h3>
                  <p className="text-base sm:text-lg whitespace-pre-line">
                    Once we receive your returned item, it will be inspected and processed within 48 business hours. You will receive a notification when it has been passed to our Quality Assurance team. Please note: If the item has been altered by a third-party jeweller, the return eligibility or warranty may be voided.
                    It typically takes up to 10 business days to complete the return process. We will notify you via email once your refund is processed or if additional information is required. We take great care to ensure that your order arrives in perfect condition. However, if your item is damaged, defective, or incorrect, please reach out to us immediately after receipt. We'll work quickly to resolve the issue to your satisfaction.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-lg sm:text-xl font-bold">Once the Return is Inspected and Approved</h3>
                  <p className="text-base sm:text-lg">
                    We will issue a refund to your original payment method within 10 business days. Please note that your bank or credit card company may take additional time to process the refund. If you haven't received your refund after 10 business days, please reach out to us at info@completecarat.com for assistance. For the quickest way to get the item you truly want, we recommend returning the original item and placing a new order for the replacement. If you need assistance with the process, our team is here to help!
                  </p>
                </div>
              </motion.div>
            </div>
              ...
              >
                <div className="w-12 h-12 flex items-center justify-center flex-shrink-0">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z" fill="#1C1B1F"/>
                  </svg>
                </div>
                <div className="flex flex-col gap-2">
                  <h3 className="text-lg sm:text-xl font-bold">Important Information</h3>
                  <p className="text-base sm:text-lg whitespace-pre-line">
                    Complete Carat reserves the right to modify this return policy at any time without prior notice. We encourage you to review our policy before completing your purchase. If you have any questions or need assistance, our friendly Customer Service team is always here to help—just reach out to us!
                    Thank you for choosing Complete Carat. We truly appreciate your trust in us and are committed to delivering a shopping experience that exceeds your expectations.
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div
              ...
              style={{
                textShadow: "0 10px 30px rgba(253, 240, 213, 0.4), 0 5px 15px rgba(231, 205, 185, 0.6)"
              }}
            >
          ...
          >
            <button
              ...
              style={{ boxShadow: "0px 0px 15px 2px rgba(253, 240, 213, 0.5), 0px 0px 8px 0px rgba(231, 205, 185, 0.3)" }}
            >
              <span className="text-base sm:text-lg uppercase tracking-wide">TALK TO OUR EXPERTS</span>
          ...
          >
            <div className="w-[240px] sm:w-[270px] h-[40px] flex items-center space-x-1 sm:space-x-2">
              <span className="text-[#FDF0D5] text-xs sm:text-sm">See Our Work</span>
